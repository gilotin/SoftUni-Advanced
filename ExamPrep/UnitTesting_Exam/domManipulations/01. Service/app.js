...
function solve() {
  ...
  let finishedSection = document.getElementById("completed-orders");
  let clearBtn = finishedSection.querySelector("button");
  ...
  function finishTask(e) {
    ...
    finishedSection.appendChild(divContainer);
    let buttons = divContainer.querySelectorAll("button");
    buttons[0].remove();
    buttons[1].remove();
  }
  function clearTask(e){
    let containers = finishedSection.querySelectorAll('.container')
